...
public class StudentMap {
	public static void main(String[] args) {
		...
		//이름을 입력하면 id:1===tel:010-1111-1111
		while(true) {
			System.out.println("이름을 입력하세요. exit를 쓰면 종료합니다.");
			String name = scanner.nextLine();
			if(name.equals("exit")) break;
			Student student = studentMap.get(name); //student 들에 name 부여
			if(student==null) System.out.println("없는 사람입니다."); // 중괄호 생략 가능
